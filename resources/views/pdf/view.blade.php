...
$col1 = $table_width / 4;
$col2 = ($table_width / 4)+30;
$col3 = $table_width / 2;
$inner_width = ($table_width /12) -6;
        ...
        <table style="height:{{$table_height}}px;width:{{$table_width}}px;{{$table_border}}; border-collapse: collapse;">
            <tr>
                ...
                <td style="{{$align_top}}; width: {{$col2}}px; {{$border_right}}; {{$col_padding}};">
                    ...
                    <div style="font-size: 8px; padding-right: 20px; word-break: break-word">
                        Beim Inhaber dieses Allergiepasses
                        besteht eine Überempfindlichkeit auf
                ...
                <td style="{{$align_top}}; width: {{$col3}}px">
                    <table style="width:100%;margin:0;height:100px;border-collapse:collapse">
                        <tr>
                        ...
                        @if ($items)
                        <tr>
                            <td colspan="5" style="{{$inner_style}}; font-size: 12px; font-weight: bold;">
                                {{__($type)}}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="{{$inner_style}}; font-size: 10px; font-weight: bold; word-break:break-word;">
                                {{$item->name}}</td>
                            <td style="{{$inner_style}}; font-size: 10px;">
                                {{$item->symptoms}}</td>
                            <td style="{{$inner_style}}; font-size: 10px;">
                                {{optional($item->verification)->format('d.m.Y')}}</td>
                            <td style="{{$inner_style}}; font-size: 10px;">
                                {{$item->suspicion ? "Ja" : ""}}</td>
                            <td style="{{$inner_style}}; font-size: 10px; color: red;">
